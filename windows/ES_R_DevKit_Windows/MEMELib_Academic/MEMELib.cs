...
public delegate void memeAcademicStandardDataReceivedDelegate(object sender, AcademicStandardData standardData);

public delegate void memeAcademicFullDataReceivedDelegate(object sender, AcademicFullData fullData);

public delegate void memeAcademicQuaternionDataReceivedDelegate(object sender, AcademicQuaternionData quaternionData);
...
public sealed class MEMELib : IDisposable
{
    ...
    public event memeAcademicStandardDataReceivedDelegate? memeAcademicStandardDataReceived;
    public event memeAcademicFullDataReceivedDelegate? memeAcademicFullDataReceived;
    public event memeAcademicQuaternionDataReceivedDelegate? memeAcademicQuaternionDataReceived;
    ...
    private void Dispatch(byte[] packet)
    {
        ...
        switch (packet[1])
        {
            ...
            case MemeProtocol.AupReportAcademia1:
                memeAcademicStandardDataReceived?.Invoke(this, MemeProtocol.ParseStandardData(packet));
                break;
            ...
            case MemeProtocol.AupReportAcademia3:
